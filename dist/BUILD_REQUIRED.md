# SMP3 2.1.0 carrier-agnostic adapter release build and artifact note

The formal `dist/` directory contains the six 2.1.0 release binaries and
...
The release is `2.1.0` and contains no runtime semantic changes. The sing
